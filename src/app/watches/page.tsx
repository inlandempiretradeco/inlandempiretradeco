...
export const metadata: Metadata = {
  title: "Watches",
  description: "New and consignment timepieces, hand-selected and available by inquiry. Browse by brand, condition, and movement.",
};
  ...
  return (
    <div style={{ maxWidth: 1320, margin: "0 auto", padding: "80px 72px" }}>
      <div style={{ marginBottom: 64, paddingBottom: 48, borderBottom: S.border }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(3rem,6vw,5.5rem)", fontWeight: 300, lineHeight: 1, color: "#fff", marginTop: 16 }}>Watches</h1>
